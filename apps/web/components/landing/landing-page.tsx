            ...
            >
                <div className="mx-auto max-w-6xl px-4 text-center">
                    ...
                    >
                        <Badge
                            variant="outline"
                            className="rounded-md border-rose-500/40 bg-linear-to-r from-rose-500/20 via-amber-500/15 to-rose-500/10 px-3.5 py-1 text-[10px] font-semibold uppercase tracking-widest text-amber-100 shadow-[0_0_24px_rgba(251,113,133,0.15)]"
                        >
                            Forms &amp; surveys
                        </Badge>
                    </motion.div>
                ...
                <div className="hex-grid-bg rounded-lg border border-zinc-800 bg-zinc-900/60 px-6 py-14 text-center md:px-12 md:py-16">
                    <SectionReveal>
                        ...
                        <p className="mx-auto mt-4 max-w-lg text-base text-zinc-400">
                            Join with HexForm to launch faster and review responses in one place.
                        </p>
